...
<html lang="en">
    ...
    <head>
        ...
        <!-- datepicker -->
        <link href="{{asset('admin/assets/libs/air-datepicker/css/datepicker.min.css')}}" rel="stylesheet" type="text/css" />
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="{{ route('dashboard.page', ['lang' => app()->getLocale()]) }}" class="waves-effect">
