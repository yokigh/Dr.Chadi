...
@section('title', __('pages.EditProduct'))
...
@section('content')
    ...
    <form action="{{ route('product.update', ['lang' => $lang, 'product' => $product->id]) }}" method="POST" enctype="multipart/form-data" class="row">
        @csrf
        @method('PUT')
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">{{ __('pages.EditProduct') }}</h4>
                    ...
                    @foreach ($languages as $lang)
                        <div class="form-group mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="name_{{ $lang }}" value="{{ $product->{'name_' . $lang} }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-3 row">
                            ...
                            <div class="col-md-10">
                                <textarea class="form-control" id="desc_{{ $lang }}" name="desc_{{ $lang }}">{{ $product->{'desc_' . $lang} }}</textarea>
                            </div>
                        </div>
                    @endforeach
                    ...
                    <div class="form-group mb-3">
                        ...
                        @if ($product->image)
                            <div class="mt-2">
                                <img src="{{ asset($product->image) }}" alt="Current Image" width="120">
                            </div>
                        @endif
                    </div>
