...
@section('title', __('pages.Createcategory'))
@section('header')
...
@section('content')
    ...
    <form action="{{ route('category.store', ['lang' => app()->getLocale()]) }}" method="POST" enctype="multipart/form-data"
        class="row">
        @csrf
        <div class="col-12">
            <div class="card">
