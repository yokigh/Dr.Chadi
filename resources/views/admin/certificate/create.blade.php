...
@section('title', __('pages.Createcertificate'))
@section('header')
...
@section('content')
    ...
    <form action="{{ route('certificates.store', ['lang' => app()->getLocale()]) }}" method="POST" enctype="multipart/form-data"
        class="row">
        @csrf
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">{{ __('pages.Create certificate') }}</h4>
                    @php
                        $languages = ['en', 'ar'];
                    @endphp
                    ...
                    <div class="form-group">
                        ...
                        <div id="drop-area" class="drop-area">
                            ...
                            <img id="image-preview"
                                ...
                                alt="Image Preview"
                                style="{{ isset($certificate) && $certificate->image ? 'display: block; margin-top: 10px; max-width: 100%;' : 'display: none;' }}">
                        </div>
                    </div>

                    <button type="submit"
                        class="btn btn-primary waves-effect waves-light">{{ __('pages.create_certificate') }}</button>
                </div>
            </div>
        </div>
    </form>
